const hours_needle = document.querySelector('.hours_needle');
const minutes_needle = document.querySelector('.minutes_needle');
const seconds_needle = document.querySelector('.seconds_needle');
